...
entropy_thresholds=(1 2 3 4 5 6 7 8)
...
do
    ...
    do
        ...
        do
            ...
            do
            python main.py --env_name delicious --algorithm ${algo} --human_feedback ${fbtype} --feedback_interval entropy --entropy_threshold ${entropy} --expert_accuracy ${exp_acc} --folder ./results_entropies/
            done
        done
    done
done
