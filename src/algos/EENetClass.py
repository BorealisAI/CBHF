...
# Copyright (c) banyikun and their affiliates
# All rights reserved.
# This source code is licensed under the license found in the
# LICENSE file in the root directory of this source tree.
################################################################
# The code is based on EE-Net: Exploitation-Exploration Neural Networks in Contextual Bandits  (https://arxiv.org/pdf/2110.03177)
# implementation from (https://github.com/banyikun/EE-Net-ICLR-2022)
##################################################################
...
class Network_exploitation(nn.Module):
    def __init__(self, dim, hidden_size=10):
...
class Network_exploration(nn.Module):
    ...
    def __init__(self, input_dim, _kernel_size=10, _stride=5, _channels=1):
