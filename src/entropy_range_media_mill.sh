...
do
    ...
    do
        ...
        do
            ...
            do
            python main.py --env_name media_mill --algorithm ${algo} --human_feedback ${fbtype} --feedback_interval entropy --entropy_threshold ${entropy} --expert_accuracy ${exp_acc} --folder ./results_entropies/
            done
        done
    done
done
