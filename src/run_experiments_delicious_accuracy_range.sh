...
do
    ...
    do
        ...
        do
        python main.py --env_name delicious --algorithm ${algo} --human_feedback ${fbtype} --feedback_interval entropy --entropy_threshold 6.5 --expert_accuracy ${exp_acc} --folder ./results_expert_range_v2/
        done
    done
done
